       ...
       <>
        <div className='p-8'>
         ...
         <div className="flex items-center gap-x-6">
            ...
            <div className="grid grid-col-1 gap-2 sm:grid-cols-3">
    ...
    return (
        ...
        <Dialog open={open} onOpenChange={setOpen}>
           <DialogContent>
               ...
               <blockquote className='mt-2 border-l-2 border-gray-300 bg-gray-50 p-4'>
                  <span className='text-sm  text-gray-600'>
                     {issue.start} - {issue.end}   
                  </span>
                  <p className='mt-1 font-medium italic leading-relaxed text-gray-900'>
                     {issue.summary}
                  </p>  
               </blockquote>
           </DialogContent>
