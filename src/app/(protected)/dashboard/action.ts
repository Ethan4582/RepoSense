...
//    //    model: google,
//    //    prompt: question,
//    //    system: "You are Reposense, a tool that helps developers understand and navigate codebases.",
//    //    maxTokens: 1000,
//    //    temperature: 0.5,
//    //  })
//   );
...
// Answer in markdown syntax, with code snippets if needed. Be as detailed as possible when answering, make sure there is no`,
//       maxTokens: 1000,
//       temperature: 0.5,
//   });
...
Answer in markdown syntax, with code snippets if needed. Be as detailed as possible when answering, make sure there is no`,
    ...
    console.error("Error in askReposense:", error);
    stream.error(error);
    throw error;
  }
}